...
export default {
    ...
    methods: {
        ...
        yhlbmkGetList(currentPage, isSearch) {
            ...
            axios
                .post('/api/auction/groupManage/init', postData)
                .then(response => {
        ...
        yhlbmkSearch(currentPage1) {
            ...
            if (this.yhlbmkIpVal) {
                ...
                let postData = this.$qs.stringify(params);
                axios
                    .post('/api/auction/groupManage/findGroupByUserName', postData)
                    .then(response => {
                        var res = response.data;
						//分页切换
                        this.yhlbmktablePageData = res.data;
        ...
        deleteGood(id) {
            ...
            console.log(postData);
            axios
                .post('/api/auction/groupManage/removeGroupManage', postData)
                .then(response => {
...
// 				});
				if(this.yhlbmkAddObj.yzm=='' || this.yhlbmkAddObj.groupNum=='' || this.model4==='' || this.model3==='' || this.goodchoiced.id==''){
					Util.error('正确填写表单');
						...
						axios
							.post('/api/auction/groupManage/addGroupManage', postData)
							.then(response => {
        ...
        updateOk() {
            ...
            let postData = this.$qs.stringify(params);
            axios
                .post('/api/auction/groupManage/updateGroupManage', postData)
                .then(response => {
                    console.log(response);
                    if (response.data.code == 200) {
                        Util.success('修改成功');
