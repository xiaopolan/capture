...
//     },
    ...
    methods: {
        ...
        yhtjGetList() {
            // 模拟请求接口返回的数据
            var res = {
                currentUserTotalNum: 100,
                currentOriginalUserNum: 200,
                currentHvUserNum: 300,
                currentLvUserNum: 400,
                currentTopUpUserNum: 500,
                todayLoginUserNum: 600,
                todayTopUpUserNum: 700,
                todayWithdrawalUserNum: 800,
                todayActiveUserNum: 900,
                todayAddUserNum: 1000
            };
            this.yhtjtableData = [res];
        },
        // 用户列表的页码改变
